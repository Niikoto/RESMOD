...
-- Fornecedores
-- -------------------------------
insert into fornecedor(nome_fornecedor,descrição) values("Fonecedor1","Teste fornecedor");
insert into fornecedor(nome_fornecedor,descrição) values("Fonecedor2","Teste fornecedor2");
...
insert into produto(nome_produto, preço, quantidade, minimo, COD_categoria, COD_fornecedor) values("Sabão",5.00,10,5,2,2);